...
TRY_TO_DATE(RKPF.RSDAT,'YYYY.MM.DD') AS RSRV_BASE_DTE,
TRY_TO_DATE(RKPF.DABRZ,'YYYY.MM.DD') AS REF_SETLMNT_DTE,
...
RKPF.ZZ_REP_ENT AS RPT_ENTR_NBR,
RKPF.ZZ_KUNNR_S AS SENDER_CUST_NAME,
RKPF.ZZ_BELNR_S AS SENDER_DOC_NBR,
RKPF.ZZ_LIFNR_S AS SENDER_VEND_NAME,
RKPF.ZZ_PAYR_S AS SENDER_PAYER,
RKPF.DUMMY_INCL_EEW_COBL AS DUMMY_FIELD,
RKPF.ZZ_LAND1 AS ENTY_CNTRY

FROM {{source('SAPSHP','RKPF')}} RKPF
WHERE RKPF.MANDT={{var('sapshpmandtftr')}}