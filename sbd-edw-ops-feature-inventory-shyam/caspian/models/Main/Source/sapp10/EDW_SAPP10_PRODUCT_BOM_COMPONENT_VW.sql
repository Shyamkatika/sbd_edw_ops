...
FROM {{source('SAPP10','STPO')}} STPO 
LEFT OUTER JOIN {{source('SAPE03','STAS')}} STAS ON STAS.STLTY = STPO.STLTY AND STAS.STLNR = STPO.STLNR AND STAS.STLKN = STPO.STLKN AND  STPO.MANDT = STAS.MANDT 
WHERE STPO.MANDT={{var('sapp10mandtftr')}}