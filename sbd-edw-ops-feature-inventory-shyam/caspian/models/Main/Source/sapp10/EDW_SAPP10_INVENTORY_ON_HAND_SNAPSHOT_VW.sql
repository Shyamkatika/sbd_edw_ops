...
--MARD.BSKRF	as	INVTY_CRCTD_FACTOR_LKEY	,
...
---MARD.DISKZ	as	SLOC_MRP_LKEY	,
TRY_TO_DATE(MARD.DLINL,'YYYYMMDD')	as	UNRSTR_USE_STK_LAST_CNT_DTE	,
---NULL	as	UNRSTR_USE_STK_LAST_CNT_DTE	,
...
FROM {{source('SAPP10','MARD')}} MARD
  WHERE MARD.MANDT={{var('sapp10mandtftr')}}
