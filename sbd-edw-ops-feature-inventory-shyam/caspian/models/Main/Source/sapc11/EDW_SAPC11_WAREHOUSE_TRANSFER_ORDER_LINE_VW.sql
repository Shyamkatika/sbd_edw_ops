...
LTAP.RSPOS  AS RSRV_REQ_PROD_ID,
LTAP.RDIFA AS RTRN_DIFF_ALT_UNIT_QTY,
LTAP.RDIFM AS RTRN_DIFF_STOCKKEEPING_UNIT_QTY,
LTAP.RLPLA AS RTRN_STORG_BIN_SUB_LOC_NAME,
...
FROM {{source('SAPC11','LTAP')}}  LTAP 
WHERE LTAP.MANDT={{var('sapc11mandtftr')}}