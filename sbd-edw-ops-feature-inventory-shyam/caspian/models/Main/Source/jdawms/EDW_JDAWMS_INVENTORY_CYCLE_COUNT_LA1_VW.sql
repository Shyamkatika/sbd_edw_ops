select 
UPPER(CONCAT(coalesce(CNTHST.CNTHST_ID ::VARCHAR,''),'~','JDAWMSLA1')) as INVTY_CYCLE_CNT_KEY,
'JDAWMS' AS  {{var('column_srcsyskey')}},
MD5(UPPER(CONCAT(coalesce(CNTHST.CNTHST_ID ::VARCHAR,''),'~','JDAWMSLA1'))) AS  {{var('column_rechashkey')}},
...
from {{source('JDAWMSLA1','CNTHST')}} CNTHST 