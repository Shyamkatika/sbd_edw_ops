select 
UPPER(CONCAT((cnttyp.cnttyp::VARCHAR),'~','JDAWMSNA1')) as CYCLE_CNT_CLS_KEY,
'JDAWMS' AS  {{var('column_srcsyskey')}},
MD5(UPPER(CONCAT((cnttyp.cnttyp::VARCHAR),'~','JDAWMSNA1'))) AS  {{var('column_rechashkey')}},
...
FROM {{source('JDAWMSNA1','CNTTYP')}} CNTTYP