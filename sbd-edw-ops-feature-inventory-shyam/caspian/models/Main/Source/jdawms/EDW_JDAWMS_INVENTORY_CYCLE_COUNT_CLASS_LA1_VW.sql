select 
UPPER(CONCAT((cnttyp.cnttyp::VARCHAR),'~','JDAWMSLA1')) as CYCLE_CNT_CLS_KEY,
'JDAWMS' AS  {{var('column_srcsyskey')}},
MD5(UPPER(CONCAT((cnttyp.cnttyp::VARCHAR),'~','JDAWMSLA1'))) AS  {{var('column_rechashkey')}},
...
FROM {{source('JDAWMSLA1','CNTTYP')}} CNTTYP