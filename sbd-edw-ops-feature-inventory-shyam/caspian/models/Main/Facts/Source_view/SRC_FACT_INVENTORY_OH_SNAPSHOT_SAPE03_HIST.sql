...
WITH DIM_PRODUCT_LOC_VALUATION_SAPE03 AS 
...
WHERE row_number=1) WHERE SRC_SYS_KEY='SAPE03')
...
CONCAT(a.CURR_FYR,a.CURR_CLNDR_PERD_NBR) END =b.FMTH_ID WHERE a.SRC_SYS_KEY IN ('SAPE03') /* AND ETL_INS_PID  LIKE '%HIST%'*/) T) OH 
LEFT JOIN DIM_PRODUCT_LOC_VALUATION_SAPE03 PLV ON (CASE WHEN OH.ETL_INS_PID LIKE '%HIST%' THEN 
...
LEFT JOIN DIM_PRODUCT_LOC_VALUATION_SAPE03 PLV1 ON 
